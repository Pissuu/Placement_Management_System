    ...
    <section class="feature-destination">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-4 element-animate ">
            <a href="Register.php" class="img-bg" style="background-image: url('images/kpmg.png')">
              <div class="text">
                <h2>KPMG</h2>
                <p>Register Now</p>
              </div>
          ...
          <div class="col-md-4 element-animate ">
            <a href="Register.php" class="img-bg" style="background-image: url('images/mu.jpg')">
              <div class="text">
                <h2>MU Sigma</h2>
                <p>Register Now</p>
              </div>
          ...
          <div class="col-md-4 element-animate ">
            <a href="Register.php" class="img-bg" style="background-image: url('images/infosys.png')">
              <div class="text">
                <h2>Infosys</h2>
                <p>Register Now</p>
              </div>
          ...
          <div class="col-md-4 element-animate ">
            <a href="Register.php" class="img-bg" style="background-image: url('images/deltax.jpg')">
              <div class="text">
                <h2>DeltaX</h2>
                <p>Register Now</p>
              </div>
